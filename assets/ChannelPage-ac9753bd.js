import{G as E,n as s,t as d,j as n,p as F,r as O,Q as j,M as A,C as I,H as V}from"./index-d29feacc.js";function z(e){return E({tag:"svg",attr:{viewBox:"0 0 16 16",fill:"currentColor"},child:[{tag:"path",attr:{d:"M1 1.91L1.78 1.5L15 7.44899V8.3999L1.78 14.33L1 13.91L2.58311 8L1 1.91ZM3.6118 8.5L2.33037 13.1295L13.5 7.8999L2.33037 2.83859L3.6118 7.43874L9 7.5V8.5H3.6118Z"}}]})(e)}const R=s.div`
...
margin-top:26px;
margin-bottom:26px;
`,_=({messages:e})=>{function t(o){const l=String(o.getDate()).padStart(2,"0"),f=String(o.getMonth()+1).padStart(2,"0"),J=o.getFullYear();return`${l}-${f}-${J}`}const a=new Date,r=new Date(a);r.setDate(a.getDate()-1);const i=t(a),c=t(r),u=o=>o===i?"today":o===c?"yesterday":o,h=e.reduce((o,l)=>{const f=t(l.date);return o[f]||(o[f]=[]),o[f].push(l),o},{});return console.log("data",h),n.jsx(R,{children:n.jsx(B,{children:Object.keys(h).map(o=>n.jsxs("div",{children:[n.jsxs(X,{children:[n.jsx(K,{children:u(o)}),n.jsx("hr",{})]}),n.jsx("ul",{children:h[o].map(l=>n.jsx(ee,{el:l},l.id))})]},o))})})},ee=({el:e})=>{function t(a){const r=a.getHours(),i=a.getMinutes(),c=r>=12?"PM":"AM";return`${r%12===0?12:r%12}:${i<10?"0":""}${i} ${c}`}return n.jsxs(H,{owner:e.owner,children:[n.jsxs(N,{owner:e.owner,children:[n.jsx(q,{children:n.jsx(G,{src:e.image,alt:e.name})}),e.isOnline&&n.jsx(P,{})]}),n.jsxs(U,{owner:e.owner,children:[!e.owner&&n.jsx(Y,{children:e.name}),n.jsx(Q,{owner:e.owner,children:e.text}),n.jsx(W,{owner:e.owner,children:t(e.date)})]})]})},te=s.div`
  width: ${d.breakpoints.mobile}px;
position:relative;
padding-bottom:20px;
