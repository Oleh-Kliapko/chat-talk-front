import{n as i,t as c,r as w,j as n,x as V,P as A,Q as S,u as B,e as z,h as H,G as N,C as P,a as q}from"./index-ddfabd26.js";import{H as G}from"./Header-5b08f35d.js";import{b as U}from"./index.esm-710da682.js";import{G as Y}from"./iconBase-263d589c.js";import"./index.esm-a734c1fa.js";function Q(e){return Y({tag:"svg",attr:{viewBox:"0 0 16 16",fill:"currentColor"},child:[{tag:"path",attr:{d:"M1 1.91L1.78 1.5L15 7.44899V8.3999L1.78 14.33L1 13.91L2.58311 8L1 1.91ZM3.6118 8.5L2.33037 13.1295L13.5 7.8999L2.33037 2.83859L3.6118 7.43874L9 7.5V8.5H3.6118Z"}}]})(e)}const W=i.div`
...
margin-top:26px;
margin-bottom:26px;
`,de=({messages:e})=>{const t=w.useRef(),a=()=>{t.current.scrollIntoView({behavior:"smooth",block:"end"})};w.useEffect(()=>{a()},[e]);function r(s){const h=String(s.getDate()).padStart(2,"0"),u=String(s.getMonth()+1).padStart(2,"0"),O=s.getFullYear();return`${h}-${u}-${O}`}const o=new Date,l=new Date(o);l.setDate(o.getDate()-1);const m=r(o),d=r(l),g=s=>s===m?"today":s===d?"yesterday":s,p=e.reduce((s,h)=>{const u=r(h.date);return s[u]||(s[u]=[]),s[u].push(h),s},{});return n.jsx(W,{children:n.jsx(K,{ref:t,children:Object.keys(p).map(s=>n.jsxs("div",{children:[n.jsxs(le,{children:[n.jsx(se,{children:g(s)}),n.jsx("hr",{})]}),n.jsx("ul",{children:p[s].map((h,u,O)=>u>0&&h.name===O[u-1].name?n.jsx(C,{repeatMsg:!1,el:h},h.id):n.jsx(C,{repeatMsg:!0,el:h},h.id))})]},s))})})},C=({el:e,repeatMsg:t})=>{function a(r){const o=r.getHours(),l=r.getMinutes(),m=o>=12?"PM":"AM";return`${o%12===0?12:o%12}:${l<10?"0":""}${l} ${m}`}return n.jsxs(X,{owner:e.owner,children:[n.jsxs(_,{owner:e.owner,children:[n.jsx(ee,{repeatMsg:t,children:n.jsx(te,{src:e.image,alt:e.name})}),e.isOnline&&t&&n.jsx(ne,{})]}),n.jsxs(ae,{repeatMsg:t,owner:e.owner,children:[!e.owner&&n.jsx(re,{children:e.name}),n.jsx(oe,{owner:e.owner,children:e.text}),n.jsx(ie,{owner:e.owner,children:a(e.date)})]})]})},ce=i.div`
  width: ${c.breakpoints.mobile}px;
position:relative;
padding-bottom:20px;
