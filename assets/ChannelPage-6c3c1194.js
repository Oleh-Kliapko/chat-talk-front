import{n as i,t as p,r as x,j as r,x as z,P as A,u as O,e as N,h as H,G as P,C as q,a as G}from"./index-1b9371b4.js";import{H as J}from"./Header-4c1852c9.js";import{b as U}from"./index.esm-54e9758f.js";import{G as W}from"./iconBase-a7d1367b.js";import"./index.esm-6143dbba.js";function Y(e){return W({tag:"svg",attr:{viewBox:"0 0 16 16",fill:"currentColor"},child:[{tag:"path",attr:{d:"M1 1.91L1.78 1.5L15 7.44899V8.3999L1.78 14.33L1 13.91L2.58311 8L1 1.91ZM3.6118 8.5L2.33037 13.1295L13.5 7.8999L2.33037 2.83859L3.6118 7.43874L9 7.5V8.5H3.6118Z"}}]})(e)}const Z=i.div`
...
margin-top:26px;
margin-bottom:26px;
`,ce=({messages:e})=>{const t=x.useRef(),o=()=>{t.current.scrollIntoView({behavior:"smooth",block:"end"})};x.useEffect(()=>{o()},[e]);function n(s){const u=String(s.getDate()).padStart(2,"0"),h=String(s.getMonth()+1).padStart(2,"0"),S=s.getFullYear();return`${u}-${h}-${S}`}const a=new Date,c=new Date(a);c.setDate(a.getDate()-1);const l=n(a),g=n(c),d=s=>s===l?"today":s===g?"yesterday":s,f=e.reduce((s,u)=>{const h=n(u.date);return s[h]||(s[h]=[]),s[h].push(u),s},{});return r.jsx(Z,{children:r.jsx(K,{ref:t,children:Object.keys(f).map(s=>r.jsxs("div",{children:[r.jsxs(ie,{children:[r.jsx(ae,{children:d(s)}),r.jsx("hr",{})]}),r.jsx("ul",{children:f[s].map((u,h,S)=>h>0&&u.name===S[h-1].name?r.jsx(L,{repeatMsg:!1,el:u},u.id):r.jsx(L,{repeatMsg:!0,el:u},u.id))})]},s))})})},L=({el:e,repeatMsg:t})=>{function o(n){const a=n.getHours(),c=n.getMinutes(),l=a>=12?"PM":"AM";return`${a%12===0?12:a%12}:${c<10?"0":""}${c} ${l}`}return r.jsxs(Q,{owner:e.owner,children:[r.jsxs(X,{owner:e.owner,children:[r.jsx(_,{repeatMsg:t,children:r.jsx(ee,{src:e.image,alt:e.name})}),e.isOnline&&t&&r.jsx(te,{})]}),r.jsxs(re,{repeatMsg:t,owner:e.owner,children:[!e.owner&&r.jsx(ne,{children:e.name}),r.jsx(oe,{owner:e.owner,children:e.text}),r.jsx(se,{owner:e.owner,children:o(e.date)})]})]})},le=i.div`
  width: ${p.breakpoints.mobile}px;
position:relative;
padding-bottom:20px;
