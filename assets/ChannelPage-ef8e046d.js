import{n as i,t as c,r as w,j as n,w as R,Q as S,u as V,d as A,f as B,G as z,C as H,F as N}from"./index-38c3d544.js";import{H as q}from"./Header-7968c67f.js";import{b as G}from"./index.esm-973929bf.js";import{G as P}from"./iconBase-95557f32.js";import"./index.esm-cc93560e.js";function U(e){return P({tag:"svg",attr:{viewBox:"0 0 16 16",fill:"currentColor"},child:[{tag:"path",attr:{d:"M1 1.91L1.78 1.5L15 7.44899V8.3999L1.78 14.33L1 13.91L2.58311 8L1 1.91ZM3.6118 8.5L2.33037 13.1295L13.5 7.8999L2.33037 2.83859L3.6118 7.43874L9 7.5V8.5H3.6118Z"}}]})(e)}const Y=i.div`
...
margin-top:26px;
margin-bottom:26px;
`,se=({messages:e})=>{const t=w.useRef();console.log("MessageList");const a=()=>{t.current.scrollIntoView({behavior:"smooth",block:"end"})};w.useEffect(()=>{a()},[e]);function r(s){const m=String(s.getDate()).padStart(2,"0"),u=String(s.getMonth()+1).padStart(2,"0"),O=s.getFullYear();return`${m}-${u}-${O}`}const o=new Date,l=new Date(o);l.setDate(o.getDate()-1);const p=r(o),d=r(l),g=s=>s===p?"today":s===d?"yesterday":s,h=e.reduce((s,m)=>{const u=r(m.date);return s[u]||(s[u]=[]),s[u].push(m),s},{});return console.log("data",h),n.jsx(Y,{children:n.jsx(Q,{ref:t,children:Object.keys(h).map(s=>n.jsxs("div",{children:[n.jsxs(ie,{children:[n.jsx(oe,{children:g(s)}),n.jsx("hr",{})]}),n.jsx("ul",{children:h[s].map((m,u,O)=>u>0&&m.name===O[u-1].name?n.jsx(C,{repeatMsg:!1,el:m},m.id):n.jsx(C,{repeatMsg:!0,el:m},m.id))})]},s))})})},C=({el:e,repeatMsg:t})=>{function a(r){const o=r.getHours(),l=r.getMinutes(),p=o>=12?"PM":"AM";return`${o%12===0?12:o%12}:${l<10?"0":""}${l} ${p}`}return n.jsxs(W,{owner:e.owner,children:[n.jsxs(K,{owner:e.owner,children:[n.jsx(X,{repeatMsg:t,children:n.jsx(_,{src:e.image,alt:e.name})}),e.isOnline&&t&&n.jsx(ee,{})]}),n.jsxs(te,{repeatMsg:t,owner:e.owner,children:[!e.owner&&n.jsx(ne,{children:e.name}),n.jsx(ae,{owner:e.owner,children:e.text}),n.jsx(re,{owner:e.owner,children:a(e.date)})]})]})},le=i.div`
  width: ${c.breakpoints.mobile}px;
position:relative;
padding-bottom:20px;
