import{n as c,t as p,r as x,j as r,P as z,u as A,e as L,h as O,G as N,C as H,a as P}from"./index-4f2593b1.js";import{H as q}from"./Header-91ef2ad3.js";import{b as G}from"./index.esm-56e17794.js";import{G as J}from"./iconBase-1273a520.js";import"./index.esm-056bcf06.js";function U(e){return J({tag:"svg",attr:{viewBox:"0 0 16 16",fill:"currentColor"},child:[{tag:"path",attr:{d:"M1 1.91L1.78 1.5L15 7.44899V8.3999L1.78 14.33L1 13.91L2.58311 8L1 1.91ZM3.6118 8.5L2.33037 13.1295L13.5 7.8999L2.33037 2.83859L3.6118 7.43874L9 7.5V8.5H3.6118Z"}}]})(e)}const W=c.div`
...
`;var ue={exports:{}},S=1;function de(){return S=(S*9301+49297)%233280,S/233280}function fe(e){S=e}var pe={nextValue:de,seed:fe},M=pe,w="0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ_-",m,F,b;function k(){b=!1}function T(e){if(!e){m!==w&&(m=w,k());return}if(e!==m){if(e.length!==w.length)throw new Error("Custom alphabet for shortid must be "+w.length+" unique characters. You submitted "+e.length+" characters: "+e);var t=e.split("").filter(function(n,o,i){return o!==i.lastIndexOf(n)});if(t.length)throw new Error("Custom alphabet for shortid must be "+w.length+" unique characters. These characters were not unique: "+t.join(", "));m=e,k()}}function he(e){return T(e),m}function ge(e){M.seed(e),F!==e&&(k(),F=e)}function xe(){m||T(w);for(var e=m.split(""),t=[],n=M.nextValue(),o;e.length>0;)n=M.nextValue(),o=Math.floor(n*e.length),t.push(e.splice(o,1)[0]);return t.join("")}function V(){return b||(b=xe(),b)}function me(e){var t=V();return t[e]}function we(){return m||w}var D={get:we,characters:he,seed:ge,lookup:me,shuffled:V},$=typeof window=="object"&&(window.crypto||window.msCrypto),C;!$||!$.getRandomValues?C=function(e){for(var t=[],n=0;n<e;n++)t.push(Math.floor(Math.random()*256));return t}:C=function(e){return $.getRandomValues(new Uint8Array(e))};var ve=C,be=function(e,t,n){for(var o=(2<<Math.log(t.length-1)/Math.LN2)-1,i=-~(1.6*o*n/t.length),l="";;)for(var f=e(i),h=i;h--;)if(l+=t[f[h]&o]||"",l.length===+n)return l},ye=D,je=ve,Se=be;function $e(e){for(var t=0,n,o="";!n;)o=o+Se(je,ye.get(),1),n=e<Math.pow(16,t+1),t++;return o}var Me=$e,y=Me,ke=1567752802062,Ce=7,j,R;function De(e){var t="",n=Math.floor((Date.now()-ke)*.001);return n===R?j++:(j=0,R=n),t=t+y(Ce),t=t+y(e),j>0&&(t=t+y(j)),t=t+y(n),t}var Le=De,Ie=D;function Ee(e){if(!e||typeof e!="string"||e.length<6)return!1;var t=new RegExp("[^"+Ie.get().replace(/[|\\{}()[\]^$+*?.-]/g,"\\$&")+"]");return!t.test(e)}var Fe=Ee;(function(e){var t=D,n=Le,o=Fe,i=0;function l(u){return t.seed(u),e.exports}function f(u){return i=u,e.exports}function h(u){return u!==void 0&&t.characters(u),t.shuffled()}function g(){return n(i)}e.exports=g,e.exports.generate=g,e.exports.seed=l,e.exports.worker=f,e.exports.characters=h,e.exports.isValid=o})(ue);const B=({handleSubmit:e})=>{const[t,n]=x.useState("");return r.jsxs(ie,{children:[r.jsx(le,{type:"text",placeholder:"Start typing...",maxLength:200,value:t,onChange:o=>n(o.target.value)}),r.jsxs(ce,{ButtonsContainer:!0,children:[r.jsx(E,{type:"button",onClick:()=>console.log("click"),children:r.jsx(G,{size:16,color:"#8E8E93"})}),r.jsx(E,{type:"button",onClick:()=>{e(t),n("")},children:r.jsx(U,{size:16,color:"#3D3D3D"})})]})]})};B.propTypes={setMessages:z.func};const Ae=()=>{const e=A(),[t,n]=x.useState([]);console.log("messages",t);const[o,i]=x.useState(null),l=localStorage.getItem("accessToken"),{currentChannel:f,isLoading:h}=L(s=>s.channels),{userId:g}=L(s=>s.auth.user),{channelId:u}=O();x.useEffect(()=>{e(N(u))},[u,e]),x.useEffect(()=>{const s=new WebSocket(`wss://talk-chat6.onrender.com/ws/chat/?channel_id=${u}&token=${l}`);i(s)},[u,l]),console.log(o),x.useEffect(()=>{o&&(o.onmessage=function({data:s}){console.log("data",JSON.parse(s));const d=JSON.parse(s);n(v=>[...v,{id:d.message_id,text:d.message,date:new Date(d.created_at),owner:g===d.user_id,name:d.username,image:d.profile_photo,isOnline:!0}])})},[u,l,g,o]);const a=s=>{console.log("message",s),o.send(JSON.stringify({message:s}))};return console.log(t),f?r.jsx(H,{children:h?r.jsx(P,{}):r.jsxs(r.Fragment,{children:[r.jsx(q,{goBack:!0,imageUrl:f.image,channelName:f.title,id:f.id}),r.jsx(ae,{messages:t}),r.jsx(B,{setMessages:n,handleSubmit:a})]})}):null};export{Ae as default};
